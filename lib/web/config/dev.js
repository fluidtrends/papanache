...
function DevConfig(options) {
    ...
    return {
        ...
        entry: [
            ...
            path_1.default.resolve(options.stackDir, 'src', 'web', 'main.tsx')
        ],
        mode: 'development',
        output: {
            filename: "app.js",
            path: path_1.default.resolve(options.productDir, '.web'),
            libraryTarget: 'umd',
            publicPath: '/'
        },
        devtool: 'source-map',
        ...
        resolve: {
            ...
            modules: [
                path_1.default.resolve(options.productDir),
                path_1.default.resolve(options.productDir, "node_modules"),
                path_1.default.resolve(options.bundleDir),
                path_1.default.resolve(options.bundleDir, "node_modules"),
                'node_modules'
            ]
        },
        module: {
        ...
        devServer: {
            ...
            liveReload: true,
            port: options.port,
            contentBase: path_1.default.resolve(options.productDir, '.web'),
