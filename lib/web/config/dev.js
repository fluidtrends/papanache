...
function DevConfig(options) {
    ...
    return {
        ...
        entry: [
            ...
            path_1.default.resolve(options.dir, 'node_modules', options.stack, 'src', 'web', 'main.tsx')
        ],
        mode: 'development',
        output: {
            filename: "app.js",
            path: path_1.default.resolve(options.dir, 'products', options.name, '.web'),
            libraryTarget: 'umd',
            publicPath: '/'
        },
        devtool: 'source-map',
        ...
        resolve: {
            ...
            alias: {
                "__product": path_1.default.resolve(options.dir, 'products', options.name),
                "__webapp": path_1.default.resolve(options.dir, 'products', options.name, 'web'),
                moment: 'moment/moment.js',
                'react-dom': require.resolve('@hot-loader/react-dom')
            },
            modules: [
                path_1.default.resolve(options.dir, 'products', options.name, 'node_modules'),
                path_1.default.resolve(options.dir, 'node_modules'),
                'node_modules'
            ]
        },
        module: {
        ...
        devServer: {
            ...
            liveReload: true,
            port: options.port,
            contentBase: path_1.default.resolve(options.dir, 'products', options.name, '.web'),
