...
var StaticPlugin = /** @class */ (function () {
    ...
    StaticPlugin.prototype.apply = function (compiler) {
        ...
        compiler.hooks.compilation.tap(this.constructor.name, function (compilation) {
            html_webpack_plugin_1.default.getHooks(compilation).beforeAssetTagGeneration.tapAsync('papanache', function (data, done) { return _this.generate(compilation, data, done); });
        });
    };
    return StaticPlugin;
}());
