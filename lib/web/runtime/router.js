...
exports.createSectionRoutes = void 0;
function createSectionRoutes(section, generator) {
    ...
    section.stack.forEach(function (element) {
        ...
        if (element && typeof element === 'string') {
            ...
            var composedRoutes = [];
            element.forEach(function (subElement) { composedRoutes = composedRoutes.concat(generator(subElement, section)); });
...
exports.createSectionRoutes = createSectionRoutes;
